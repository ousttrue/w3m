...
{
    reAnchorPos(base_url, doc, l, &l->lineBuf[spos], &l->lineBuf[epos], doc_put_anchor_all);
}
...
{
    return reAnchorAny(base_url, doc, re, doc_put_anchor_all);
}
