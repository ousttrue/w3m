...
static void insertself(unsigned char c), _mvR(unsigned char),
    _mvL(unsigned char), _mvRw(unsigned char), _mvLw(unsigned char),
    delC(unsigned char), insC(unsigned char), _mvB(unsigned char),
    _mvE(unsigned char), _enter(unsigned char), _quo(unsigned char),
    _bs(unsigned char), _bsw(unsigned char), killn(unsigned char),
    killb(unsigned char), _inbrk(unsigned char), _esc(unsigned char),
    _editor(unsigned char), _prev(unsigned char), _next(unsigned char),
    _compl(unsigned char), _tcompl(unsigned char), _dcompl(unsigned char),
    _rdcompl(unsigned char), _rcompl(unsigned char);

static int terminated(unsigned char c);
#define iself ((void (*)(unsigned char))insertself)
...
/* *INDENT-OFF* */
void (*InputKeymap[32])(unsigned char) = {
