...
static Str
process_hr(struct HtmlTagParsed* tag, int width, int indent_width)
{
...
static Str
process_form_int(struct HtmlTagParsed* tag, int fid)
{
    char *p, *q, *r, *s, *tg, *n;
...
static void
process_idattr(struct readbuffer* obuf, int cmd, struct HtmlTagParsed* tag)
{
