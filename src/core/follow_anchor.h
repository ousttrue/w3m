...
void query_from_followform(struct Document* doc, struct BufferPoint bp, Str* query, struct FormItem* fi, int multipart);
...
typedef struct Anchor* (*AnchorMenuFunc)(struct UI* ui, struct Document*);
