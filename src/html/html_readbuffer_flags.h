...
enum ReadBufferFlags {
  ...
  TBLM_PREMODE = (TBLM_PRE | TBLM_PRE_INT | TBLM_SCRIPT | TBLM_STYLE |
                  TBLM_PLAIN | TBLM_INTXTA),
  TBLM_SPECIAL = (TBLM_PRE | TBLM_PRE_INT | TBLM_SCRIPT | TBLM_STYLE |
                  TBLM_PLAIN | TBLM_NOBR),
  TBLM_DEL = RB_DEL,
  TBLM_S = RB_S,
};
