...
struct TagInfo TagMAP[MAX_HTMLTAG] = {
    ...
    {"/option", nullptr, 0, TFLG_END},             /*  94 HTML_N_OPTION   */
    {"head", ALST_NOP, MAXA_NOP, 0},               /*  95 HTML_HEAD       */
    {"/head", nullptr, 0, TFLG_END},               /*  96 HTML_N_HEAD     */
    {"doctype", ALST_DOCTYPE, MAXA_DOCTYPE, 0},    /*  97 HTML_DOCTYPE    */
    {"noframes", ALST_NOFRAMES, MAXA_NOFRAMES, 0}, /*  98 HTML_NOFRAMES   */
    {"/noframes", nullptr, 0, TFLG_END},           /*  99 HTML_N_NOFRAMES */

    {"sup", ALST_NOP, MAXA_NOP, 0},          /* 100 HTML_SUP       */
    {"/sup", nullptr, 0, TFLG_END},          /* 101 HTML_N_SUP       */
    {"sub", ALST_NOP, MAXA_NOP, 0},          /* 102 HTML_SUB       */
    {"/sub", nullptr, 0, TFLG_END},          /* 103 HTML_N_SUB       */
    {"link", ALST_LINK, MAXA_LINK, 0},       /*  104 HTML_LINK      */
    {"s", ALST_NOP, MAXA_NOP, 0},            /*  105 HTML_S        */
    {"/s", nullptr, 0, TFLG_END},            /*  106 HTML_N_S      */
    {"q", ALST_NOP, MAXA_NOP, 0},            /*  107 HTML_Q */
    {"/q", nullptr, 0, TFLG_END},            /*  108 HTML_N_Q */
    {"i", ALST_NOP, MAXA_NOP, 0},            /*  109 HTML_I */
    {"/i", nullptr, 0, TFLG_END},            /*  110 HTML_N_I */
    {"strong", ALST_NOP, MAXA_NOP, 0},       /* 111 HTML_STRONG */
    {"/strong", nullptr, 0, TFLG_END},       /* 112 HTML_N_STRONG */
    {"span", ALST_NOP, MAXA_NOP, 0},         /* 113 HTML_SPAN       */
    {"/span", nullptr, 0, TFLG_END},         /* 114 HTML_N_SPAN     */
    {"abbr", ALST_NOP, MAXA_NOP, 0},         /* 115 HTML_ABBR */
    {"/abbr", nullptr, 0, TFLG_END},         /* 116 HTML_N_ABBR */
    {"acronym", ALST_NOP, MAXA_NOP, 0},      /* 117 HTML_ACRONYM */
    {"/acronym", nullptr, 0, TFLG_END},      /* 118 HTML_N_ACRONYM */
    {"basefont", ALST_NOP, MAXA_NOP, 0},     /* 119 HTML_BASEFONT */
    {"bdo", ALST_NOP, MAXA_NOP, 0},          /* 120 HTML_BDO */
    {"/bdo", nullptr, 0, TFLG_END},          /* 121 HTML_N_BDO */
    {"big", ALST_NOP, MAXA_NOP, 0},          /* 122 HTML_BIG */
    {"/big", nullptr, 0, TFLG_END},          /* 123 HTML_N_BIG */
    {"button", ALST_BUTTON, MAXA_BUTTON, 0}, /* 124 HTML_BUTTON */
    {"/button", nullptr, 0, TFLG_END},       /* 125 HTML_N_BUTTON */
    {"fieldset", ALST_NOP, MAXA_NOP, 0},     /* 126 HTML_FIELDSET */
    {"/fieldset", nullptr, 0, TFLG_END},     /* 127 HTML_N_FIELDSET */
    {"iframe", ALST_NOP, MAXA_NOP, 0},       /* 128 HTML_IFRAME */
    {"label", ALST_NOP, MAXA_NOP, 0},        /* 129 HTML_LABEL */
    {"/label", nullptr, 0, TFLG_END},        /* 130 HTML_N_LABEL */
    {"legend", ALST_NOP, MAXA_NOP, 0},       /* 131 HTML_LEGEND */
    {"/legend", nullptr, 0, TFLG_END},       /* 132 HTML_N_LEGEND */
    {"noscript", ALST_NOP, MAXA_NOP, 0},     /* 133 HTML_NOSCRIPT */
    {"/noscript", nullptr, 0, TFLG_END},     /* 134 HTML_N_NOSCRIPT */
    {"object", ALST_NOP, MAXA_NOP, 0},       /* 135 HTML_OBJECT */
    {"optgroup", ALST_NOP, MAXA_NOP, 0},     /* 136 HTML_OPTGROUP */
    {"/optgroup", nullptr, 0, TFLG_END},     /* 137 HTML_N_OPTGROUP */
    {"param", ALST_NOP, MAXA_NOP, 0},        /* 138 HTML_PARAM */
    {"small", ALST_NOP, MAXA_NOP, 0},        /* 139 HTML_SMALL */
    {"/small", nullptr, 0, TFLG_END},        /* 140 HTML_N_SMALL */
    {"figure", ALST_P, MAXA_P, 0},           /* 141 HTML_FIGURE */
    {"/figure", nullptr, 0, TFLG_END},       /* 142 HTML_N_FIGURE */
    {"figcaption", ALST_P, MAXA_P, 0},       /* 143 HTML_FIGCAPTION */
    {"/figcaption", nullptr, 0, TFLG_END},   /* 144 HTML_N_FIGCAPTION */
    {"section", ALST_NOP, MAXA_NOP, 0},      /* 145 HTML_SECTION */
    {"/section", nullptr, 0, TFLG_END},      /* 146 HTML_N_SECTION */
    {"/dt", nullptr, 0, TFLG_END},           /* 147 HTML_N_DT */
    {"/dd", nullptr, 0, TFLG_END},           /* 148 HTML_N_DD */

    {nullptr, nullptr, 0, 0}, /* 149 Undefined */
    {nullptr, nullptr, 0, 0}, /* 150 Undefined */
    {nullptr, nullptr, 0, 0}, /* 151 Undefined */
    {nullptr, nullptr, 0, 0}, /* 152 Undefined */
    {nullptr, nullptr, 0, 0}, /* 153 Undefined */
    {nullptr, nullptr, 0, 0}, /* 154 Undefined */
    {nullptr, nullptr, 0, 0}, /* 155 Undefined */
    {nullptr, nullptr, 0, 0}, /* 156 Undefined */
    {nullptr, nullptr, 0, 0}, /* 157 Undefined */
    {nullptr, nullptr, 0, 0}, /* 158 Undefined */
    {nullptr, nullptr, 0, 0}, /* 159 Undefined */

    /* pseudo tag */
    {"select_int", ALST_SELECT_INT, MAXA_SELECT_INT,
     TFLG_INT}, /* 160 HTML_SELECT_INT   */
    {"/select_int", nullptr, 0,
     TFLG_INT | TFLG_END}, /* 161 HTML_N_SELECT_INT */
    {"option_int", ALST_OPTION, MAXA_OPTION,
     TFLG_INT}, /* 162 HTML_OPTION_INT   */
    {"textarea_int", ALST_TEXTAREA_INT, MAXA_TEXTAREA_INT,
     TFLG_INT}, /* 163 HTML_TEXTAREA_INT   */
    {"/textarea_int", nullptr, 0,
     TFLG_INT | TFLG_END}, /* 164 HTML_N_TEXTAREA_INT */
    {"table_alt", ALST_TABLE_ALT, MAXA_TABLE_ALT,
     TFLG_INT},                                     /* 165 HTML_TABLE_ALT   */
    {"symbol", ALST_SYMBOL, MAXA_SYMBOL, TFLG_INT}, /* 166 HTML_SYMBOL */
    {"/symbol", nullptr, 0, TFLG_INT | TFLG_END},   /* 167 HTML_N_SYMBOL      */
    {"pre_int", nullptr, 0, TFLG_INT},              /* 168 HTML_PRE_INT     */
    {"/pre_int", nullptr, 0, TFLG_INT | TFLG_END},  /* 169 HTML_N_PRE_INT   */
    {"title_alt", ALST_TITLE_ALT, MAXA_TITLE_ALT,
     TFLG_INT}, /* 170 HTML_TITLE_ALT   */
    {"form_int", ALST_FORM_INT, MAXA_FORM_INT,
     TFLG_INT},                                     /* 171 HTML_FORM_INT    */
    {"/form_int", nullptr, 0, TFLG_INT | TFLG_END}, /* 172 HTML_N_FORM_INT  */
    {"dl_compact", nullptr, 0, TFLG_INT},           /* 173 HTML_DL_COMPACT  */
    {"input_alt", ALST_INPUT_ALT, MAXA_INPUT_ALT,
     TFLG_INT},                                      /* 174 HTML_INPUT_ALT   */
    {"/input_alt", nullptr, 0, TFLG_INT | TFLG_END}, /* 175 HTML_N_INPUT_ALT */
    {"img_alt", ALST_IMG_ALT, MAXA_IMG_ALT, TFLG_INT}, /* 176 HTML_IMG_ALT */
    {"/img_alt", nullptr, 0, TFLG_INT | TFLG_END}, /* 177 HTML_N_IMG_ALT   */
    {" ", ALST_NOP, MAXA_NOP, TFLG_INT},           /* 178 HTML_NOP         */
    {"pre_plain", nullptr, 0, TFLG_INT}, /* 179 HTML_PRE_PLAIN         */
    {"/pre_plain", nullptr, 0, TFLG_INT | TFLG_END}, /* 180 HTML_N_PRE_PLAIN */
    {"internal", nullptr, 0, TFLG_INT},              /* 181 HTML_INTERNAL   */
    {"/internal", nullptr, 0, TFLG_INT | TFLG_END},  /* 182 HTML_N_INTERNAL   */
    {"div_int", ALST_P, MAXA_P, TFLG_INT},           /*  183 HTML_DIV_INT    */
    {"/div_int", nullptr, 0, TFLG_INT | TFLG_END},   /*  184 HTML_N_DIV_INT  */
};

struct TagAttrInfo AttrMAP[MAX_TAGATTR] = {
    {nullptr, VTYPE_NONE, 0},         /*  0 ATTR_UNKNOWN        */
    ...
    {nullptr, VTYPE_NONE, 0},         /* 52 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 53 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 54 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 55 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 56 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 57 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 58 Undefined           */
    {nullptr, VTYPE_NONE, 0},         /* 59 Undefined           */
