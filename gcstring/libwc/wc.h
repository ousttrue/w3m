...
inline static Str wc_conv_n(const char* is, int n, wc_ces f_ces, wc_ces t_ces)
{
...
inline static Str wc_conv_n_strict(const char* is, int n, wc_ces f_ces, wc_ces t_ces)
{
...
inline static Str wc_conv_n_with_detect(const char* is, int n, wc_ces* f_ces, wc_ces hint, wc_ces t_ces)
{
