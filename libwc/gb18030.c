...
wc_uint8 WC_GB18030_MAP[0x100] = {
    ...
    C0, C0, C0, C0, C0, C0, C0, C0, C0, C0, C0, C0, C0, GL, GL, GL, GL, GL, GL,
    GL, GL, GL, GL, GL, GL, GL, GL, GL, GL, L4, L4, L4, L4, L4, L4, L4, L4, L4,
    L4, GL, GL, GL, GL, GL, GL, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB,
    LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB,
    LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB,
    LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, LB, C0,

    LB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB,
    UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB,
    UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB,
    UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB,
    UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB,
    UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB,
    UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, UB, C1,
};
...
static wc_ccs wc_gbk_or_gbk_ext(wc_uint16 code) {
  return wc_map3_range_search(code, gbk_ext_ucs_map, N_gbk_ext_ucs_map)
             ? WC_CCS_GBK_EXT
             : WC_CCS_GBK;
}
    ...
    case WC_GB18030_MBYTE3:
      if (WC_GB18030_MAP[*p] == L4) {
        ...
        cc.code = ((wc_uint32) * (p - 3) << 24) |
                  ((wc_uint32) * (p - 2) << 16) | ((wc_uint32) * (p - 1) << 8) |
                  *p;
...
Str wc_char_conv_from_gb18030(wc_uchar c, wc_status *st) {
  ...
  case WC_GB18030_MBYTE3:
    if (WC_GB18030_MAP[c] == L4) {
      cc.ccs = WC_CCS_GB18030_W;
      cc.code = ((wc_uint32)gb[0] << 24) | ((wc_uint32)gb[1] << 16) |
                ((wc_uint32)gb[2] << 8) | c;
      wtf_push(os, cc.ccs, cc.code);
    }
    break;
