...
struct wc_wchar
wc_gbk_to_cs128w(struct wc_wchar cc)
{
...
struct wc_wchar
wc_cs128w_to_gbk(struct wc_wchar cc)
{
...
struct wc_output wc_conv_from_gbk(struct wc_option opts, const char* is, int len, wc_ces ces)
{
    ...
    for (; p < ep; p++) {
        ...
        case WC_GBK_NOSTATE:
            ...
            case UB:
                ...
                break;
            case C80:
                wtf_push(opts, &os, WC_CCS_GBK_80, *p);
                break;
            case C1:
...
void wc_push_to_gbk(struct wc_option opts, struct wc_output* os, struct wc_wchar cc, struct wc_status* st)
{
    while (1) {
        switch (cc.ccs) {
...
struct wc_output wc_char_conv_from_gbk(struct wc_option opts, wc_uchar c, struct wc_status* st)
{
    ...
    case WC_GBK_NOSTATE:
        ...
        case C80:
            wtf_push(opts, &os, WC_CCS_GBK_80, c);
            break;
        case C1:
            break;
        default:
