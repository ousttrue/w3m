...
wc_codepage(int n)
{
    ...
    case 874:
        return WC_CES_CP874;
    case 932:
        return WC_CES_CP932; /* CP932 = Shift_JIS */
    case 936:
        return WC_CES_CP936; /* CP936 = GBK > EUC_CN */
    case 943:
        return WC_CES_CP943; /* CP943 = Shift_JIS */
    case 949:
        return WC_CES_CP949; /* CP949 = UHC > EUC_KR */
    case 950:
        return WC_CES_CP950; /* CP950 = Big5 */
    case 1006:
        return WC_CES_CP1006;
    case 1250:
        return WC_CES_CP1250;
    case 1251:
        return WC_CES_CP1251;
    case 1252:
        return WC_CES_CP1252;
    case 1253:
        return WC_CES_CP1253;
    case 1254:
        return WC_CES_CP1254;
    case 1255:
        return WC_CES_CP1255;
    case 1256:
        return WC_CES_CP1256;
    case 1257:
        return WC_CES_CP1257;
    case 1258:
        return WC_CES_CP1258;
    }
    return 0;
}
...
wc_guess_charset_short(const char* charset, wc_ces orig)
{
    if (charset == NULL || *charset == '\0')
        return orig;
    wc_ces guess = wc_charset_short_to_ces(charset);
    return guess ? guess : orig;
}

wc_ces
wc_guess_locale_charset(const char* locale, wc_ces orig)
{
    wc_ces guess;
...
wc_charset_to_ces(const char* charset)
{
    ...
    case 'e':
        if (0 == strncmp(p, "euc", 3)) {
            ...
            case 't':
                return WC_CES_EUC_TW;
            case 'k':
                return WC_CES_EUC_KR;
            }
            switch (WcLocale) {
            case WC_LOCALE_JA_JP:
                return WC_CES_EUC_JP;
            case WC_LOCALE_ZH_CN:
                return WC_CES_EUC_CN;
            case WC_LOCALE_ZH_TW:
                return WC_CES_EUC_TW;
            case WC_LOCALE_ZH_HK:
                return WC_CES_EUC_CN;
            case WC_LOCALE_KO_KR:
                return WC_CES_EUC_KR;
            }
            return WC_CES_EUC_JP;
        }
    ...
    case 'j':
        ...
        break;
    case 's':
        if (!strncmp(p, "shiftjisx0213", 13) || !strncmp(p, "sjisx0213", 9))
            return WC_CES_SHIFT_JISX0213;
        if (!strncmp(p, "shiftjis", 8) || !strncmp(p, "sjis", 4))
    ...
    case 'p':
        ...
        break;
    case 'g':
        if (!strncmp(p, "gb18030", 7) || !strncmp(p, "gbk2k", 5))
...
wc_locale_to_ces(const char* locale)
{
    ...
    if (!strcmp(buf, "japanese"))
        return WC_CES_SHIFT_JIS;
    if (!strcmp(buf, "zh_tw") || !strcmp(buf, "zh_hk"))
        return WC_CES_BIG5;
...
{
    return strcasecmp(((struct wc_ces_list*)a)->desc, ((struct wc_ces_list*)b)->desc);
}

static struct wc_ces_list* list = NULL;
...
wc_get_ces_list(void)
{
    ...
    size_t n = 0;
    for (struct wc_ces_info* info = WcCesInfo; info->id; info++) {
        if (info->name != NULL)
            n++;
    }
    list = malloc(sizeof(struct wc_ces_list) * (n + 1));
    n = 0;
    for (struct wc_ces_info* info = WcCesInfo; info->id; info++) {
        if (info->name != NULL) {
            list[n].id = info->id;
    ...
    list[n].name = NULL;
    list[n].desc = NULL;
    qsort(list, n, sizeof(struct wc_ces_list), wc_ces_list_cmp);
    return list;
}
