...
Str wc_conv_from_iso2022(Str is, enum wc_ces ces)
{
    Str os;
...
void wc_push_to_iso2022(Str os, wc_wchar_t cc, struct wc_status* st)
{
    wc_uchar g = 0;
    ...
    while (1) {
        ...
        case WC_CCS_A_CS94W:
...
#ifdef USE_UNICODE
            case WC_CCS_JIS_X_0212:
                if (!WcOption.use_jisx0212 && WcOption.use_jisx0213 && WcOption.ucs_conv) {
            ...
            case WC_CCS_JIS_X_0213_1:
            case WC_CCS_JIS_X_0213_2:
                if (!WcOption.use_jisx0213 && WcOption.use_jisx0212 && WcOption.ucs_conv) {
...
void wc_push_to_iso2022_end(Str os, struct wc_status* st)
{
...
void wc_push_iso2022_esc(Str os, wc_ccs ccs, wc_uchar g, wc_uint8 invoke, struct wc_status* st)
{
...
void wc_push_to_euc(Str os, wc_wchar_t cc, struct wc_status* st)
{
...
void wc_push_to_eucjp(Str os, wc_wchar_t cc, struct wc_status* st)
{
    while (1) {
        switch (cc.ccs) {
        case WC_CCS_US_ASCII:
...
void wc_push_to_euctw(Str os, wc_wchar_t cc, struct wc_status* st)
{
    while (1) {
        switch (cc.ccs) {
        case WC_CCS_US_ASCII:
...
void wc_push_to_iso8859(Str os, wc_wchar_t cc, struct wc_status* st)
{
    wc_ccs g1_ccs = st->ces_info->gset[1].ccs;
...
void wc_create_gmap(struct wc_status* st)
{
...
Str wc_char_conv_from_iso2022(wc_uchar c, struct wc_status* st)
{
    static Str os;
