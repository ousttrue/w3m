...
struct wc_table* wc_get_ucs_table(wc_ccs ccs);
struct wc_wchar wc_ucs_to_any(wc_uint32 ucs, struct wc_table* t);
wc_uint32 wc_any_to_ucs(struct wc_option opts, struct wc_wchar cc);
struct wc_wchar wc_any_to_any(struct wc_option opts, struct wc_wchar cc, struct wc_table* t);
struct wc_wchar wc_ucs_to_any_list(wc_uint32 ucs, struct wc_table** tlist);
struct wc_status;
struct wc_wchar wc_any_to_any_ces(struct wc_option opts, struct wc_wchar cc, struct wc_status* st);
struct wc_wchar wc_any_to_iso2022(struct wc_option opts, struct wc_wchar cc, struct wc_status* st);
struct wc_wchar wc_ucs_to_iso2022(wc_uint32 ucs);
struct wc_wchar wc_ucs_to_iso2022w(wc_uint32 ucs);
wc_ccs wc_ucs_to_ccs(struct wc_option opts, wc_uint32 ucs);
wc_bool wc_is_ucs_ambiguous_width(struct wc_option opts, wc_uint32 ucs);
wc_bool wc_is_ucs_wide(wc_uint32 ucs);
wc_bool wc_is_ucs_combining(struct wc_option opts, wc_uint32 ucs);
wc_bool wc_is_ucs_hangul(wc_uint32 ucs);
wc_bool wc_is_ucs_alpha(wc_uint32 ucs);
wc_bool wc_is_ucs_digit(wc_uint32 ucs);
...
wc_uint32 wc_ucs_precompose(struct wc_option opts, wc_uint32 ucs1, wc_uint32 ucs2);
