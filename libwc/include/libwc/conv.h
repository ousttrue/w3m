...
inline static struct wc_output wc_conv_with_detect(struct wc_option opts, const char* is, wc_ces* f_ces, wc_ces hint, wc_ces t_ces)
{
    return wc_Str_conv_with_detect(opts, is, strlen(is), f_ces, hint, t_ces);
}
inline static struct wc_output wc_conv_n_with_detect(struct wc_option opts, const char* is, int n, wc_ces* f_ces, wc_ces hint, wc_ces t_ces)
{
