...
struct wc_wchar wc_johab_to_ksx1001(struct wc_option opts, struct wc_wchar cc);
struct wc_wchar wc_ksx1001_to_johab(struct wc_option opts, struct wc_wchar cc);
struct wc_wchar wc_ucs_to_johab(wc_uint32 ucs);
wc_uint32 wc_johab1_to_N(wc_uint32 cc);
wc_uint32 wc_N_to_johab1(wc_uint32 ucs);
struct wc_wchar wc_johab_to_cs128w(struct wc_wchar cc);
struct wc_wchar wc_cs128w_to_johab(struct wc_wchar cc);
