...
extern void wc_push_to_eucjp(Str os, wc_wchar_t cc, struct wc_status *st);
extern void wc_push_to_euctw(Str os, wc_wchar_t cc, struct wc_status *st);
extern void wc_push_to_iso8859(Str os, wc_wchar_t cc, struct wc_status *st);
extern void wc_push_to_iso2022_end(Str os, struct wc_status *st);
extern int  wc_parse_iso2022_esc(wc_uchar **ptr, struct wc_status *st);
extern void wc_push_iso2022_esc(Str os, wc_ccs ccs, wc_uchar g, wc_uint8 invoke, struct wc_status *st);
extern void wc_create_gmap(struct wc_status *st);
extern Str  wc_char_conv_from_iso2022(wc_uchar c, struct wc_status *st);
