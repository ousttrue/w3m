...
static wc_gset gset_iso2022jp2[] = {
    {WC_CCS_US_ASCII, WC_C_G0_CS94, 1},   {WC_CCS_JIS_X_0208, WC_C_G0_CS94, 0},
    {WC_CCS_JIS_X_0212, WC_C_G0_CS94, 0}, {WC_CCS_GB_2312, WC_C_G0_CS94, 0},
    {WC_CCS_KS_X_1001, WC_C_G0_CS94, 0},  {WC_CCS_ISO_8859_1, WC_C_G2_CS96, 0},
    {WC_CCS_ISO_8859_7, WC_C_G2_CS96, 0}, {0, 0, 0},
};
...
static wc_uchar gset_ext_iso2022jp[] = {WC_C_G0_CS94, WC_C_G2_CS96,
                                        WC_C_G0_CS94, WC_C_G2_CS96};
static wc_uchar gset_ext_iso2022cn[] = {WC_C_G2_CS94, WC_C_G2_CS96,
                                        WC_C_G2_CS94, WC_C_G2_CS96};
static wc_uchar gset_ext_iso2022kr[] = {WC_C_G1_CS94, WC_C_G1_CS96,
...
static wc_gset gset_sjisx0213[] = {
    {WC_CCS_US_ASCII, 0, 1},        {WC_CCS_JIS_X_0208, 0x80, 1},
    {WC_CCS_JIS_X_0201K, 0x80, 1},  {WC_CCS_JIS_X_0213_1, 0x80, 1},
    {WC_CCS_JIS_X_0213_2, 0x80, 1}, {0, 0, 0},
};
...
static wc_gset gset_hkscs[] = {
    {WC_CCS_US_ASCII, 0, 1},   {WC_CCS_BIG5_1, 0x80, 1},
    {WC_CCS_BIG5_2, 0x80, 1},  {WC_CCS_BIG5, 0x80, 1},
    {WC_CCS_HKSCS_1, 0x80, 1}, {WC_CCS_HKSCS_2, 0x80, 1},
    {WC_CCS_HKSCS, 0x80, 1},   {0, 0, 0},
};
static wc_gset gset_johab[] = {
    {WC_CCS_US_ASCII, 0, 1},   {WC_CCS_JOHAB_1, 0x80, 1},
    {WC_CCS_JOHAB_2, 0x80, 1}, {WC_CCS_JOHAB_3, 0x80, 1},
    {WC_CCS_JOHAB, 0x80, 1},   {0, 0, 0},
};
...
static wc_gset gset_gb18030[] = {
    {WC_CCS_US_ASCII, 0, 1},     {WC_CCS_GB_2312, 0x80, 1},
    {WC_CCS_GBK_1, 0x80, 1},     {WC_CCS_GBK_2, 0x80, 1},
    {WC_CCS_GBK, 0x80, 1},       {WC_CCS_GBK_EXT_1, 0x80, 1},
    {WC_CCS_GBK_EXT_2, 0x80, 1}, {WC_CCS_GBK_EXT, 0x80, 1},
    {WC_CCS_GB18030, 0x80, 1},   {0, 0, 0},
};
static wc_gset gset_uhc[] = {
    {WC_CCS_US_ASCII, 0, 1}, {WC_CCS_KS_X_1001, 0x80, 1},
    {WC_CCS_UHC_1, 0x80, 1}, {WC_CCS_UHC_2, 0x80, 1},
    {WC_CCS_UHC, 0x80, 1},   {0, 0, 0},
};
...
#define ces_ascii(id, name, desc)                                              \
  {                                                                            \
    WC_CES_##id, name, desc, gset_usascii, NULL, (void *)wc_conv_from_ascii,   \
        (void *)wc_push_to_iso8859, (void *)wc_char_conv_from_iso2022          \
  }
...
#define ces_priv1(id, name, desc, ces)                                         \
  {                                                                            \
    WC_CES_##id, name, desc, gset_##ces, NULL, (void *)wc_conv_from_priv1,     \
        (void *)wc_push_to_priv1, (void *)wc_char_conv_from_priv1              \
  }
...
#define ces_priv2(id, name, desc, ces)                                         \
  {                                                                            \
    WC_CES_##id, name, desc, gset_##ces, NULL, (void *)wc_conv_from_##ces,     \
        (void *)wc_push_to_##ces, (void *)wc_char_conv_from_##ces              \
  }
...
wc_ces_info WcCesInfo[] = {
    ...
    ces_iso2022(ISO_2022_JP_2, "ISO-2022-JP-2", "Japanese (ISO-2022-JP-2)",
                jp2),
    ces_iso2022(ISO_2022_JP_3, "ISO-2022-JP-3", "Japanese (ISO-2022-JP-3)",
                jp3),
    ...
    ces_priv2(SHIFT_JISX0213, "Shift_JISX0213", "Japanese (Shift_JISX0213)",
              sjisx0213),
