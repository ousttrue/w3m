...
static struct Buffer* page_loaded(struct CmdArgs* args, struct HttpClient* http)
{
        ...
        case SCM_FILE: {
            ...
            if (S_ISDIR(st.st_mode)) {
                if (UseExternalDirBuffer) {
                    ...
                    struct Buffer* b = loadGeneralFile(args, cmd->ptr, NULL, NULL, NO_REFERER, 0);
