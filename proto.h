...
extern struct Line* lineSkip(Buffer* buf, struct Line* line, int offset, int last);
extern struct Line* currentLineSkip(Buffer* buf, struct Line* line, int offset, int last);
