...
_bool override_user_agent = (false);
const char* UserAgent = 0;
const char* AcceptLang = 0;
const char* AcceptEncoding = 0;
const char* AcceptMedia = 0;
_bool NoCache = (false);
_bool NoSendReferer = (false);
_bool CrossOriginReferer = (true);
_bool override_content_type = (false);
