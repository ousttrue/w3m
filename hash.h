...
defhash(const char *, int, si) defhash(const char *, const char *, ss)
    defhash(const char *, void *, sv) defhash(int, void *, iv)
#define defhashfunc(keytype, type, sym)                                        \
  Hash_##sym *newHash_##sym(int size) {                                        \
    ...
    return hash;                                                               \
                                                                               ...
                                                                               \
  static HashItem_##sym *lookupHash_##sym(Hash_##sym *t, keytype key,          \
                                          int *hashval_return) {               \
    HashItem_##sym *hi;                                                        \
                                                                               \
    *hashval_return = hashfunc(key) % t->size;                                 \
    ...
    return NULL;                                                               \
                                                                               ...
                                                                               \
  void putHash_##sym(Hash_##sym *t, keytype key, type value) {                 \
    int h;                                                                     \
    HashItem_##sym *hi;                                                        \
                                                                               \
    ...
    t->tab[h] = hi;                                                            \
                                                                               ...
                                                                               \
  type getHash_##sym(Hash_##sym *t, keytype key, type failval) {               \
    int h;                                                                     \
    HashItem_##sym *hi;                                                        \
                                                                               \
    hi = lookupHash_##sym(t, key, &h);                                         \
