...
static int
insert_bookmark(char* bmark, struct KeyValueList* data)
{
...
int main(void)
{
    ...
    if (sent_cookie == NULL || Local_cookie == NULL || strcmp(sent_cookie, Local_cookie) != 0) {
